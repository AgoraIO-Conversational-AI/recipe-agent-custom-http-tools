...
- Required variables:
  ...
  - `AGORA_APP_ID`, `AGORA_APP_CERTIFICATE`, and `HTTP_TOOLS_API_KEY` - server-side only, documented in `server/.env.example`
...
- Secrets handling: keep Agora certificate and the tool API key out of `web/`
